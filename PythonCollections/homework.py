...
words_frequency = {"abc": 10, "mom": 20}

"""
10. Увеличьте количество баллов игрока Bob
на 7, уменьшите баллы Alice на 10. Добавьте
...
game_score["Mike"] = 10
game_score.pop("Kate")
gamers = list(game_score.keys())
games_number = len(game_score)
...
workers_vacations = dict(zip(workers_uuids, vacations))


"""12. Постройте коллекцию, представляющих собой
