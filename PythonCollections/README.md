...
- Ключом может быть любой [хешируемый](https://www.kaspersky.ru/blog/the-wonders-of-hashing/3633/) тип данных. Для определения хешируемости данных в Python есть встроенная функция `hash`, с ее помощью можно проверять можно ли использовать определенный тип данных, как ключ в словаре, например:
    ```python
    hash(3) # 3
